...
public class Account
{
    ...
    {
        File accountadd =new File("src/Banking2/Accounts.txt");
        try
        {
            ...
            while(scn.hasNextLine())
            {
                ...
                ss= s[1].split("");
                long NLine=-1;
                try(LineNumberReader linenmr= new LineNumberReader(new FileReader(new File("src/Banking2/Accounts.txt"))))
                {
    ...
    void filehan()
    {
        try
        {
            FileWriter fos=new FileWriter("src/Banking2/Accounts.txt",true);
